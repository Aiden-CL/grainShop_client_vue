    ...
    <div class="type-wrap logo">
      ...
      <div class="value logos">
        <ul class="logo-list">
          ...
          :key="trademark.tmId" @click="searchForTrademark(trademark)"
          >{{trademark.tmName}}</li>
    ...
    >
      ...
      <div class="fl value">
        <ul class="type-list">
          ...
          :key="index">
            <a href="javascript:;" @click="searchForAttrs(attrValue,attr)">{{attrValue}}</a>
          </li>
  ...
  export default {
    ...
    methods:{
      ...
      searchForAttrs(attrValue,attr){
        this.$emit('searchForAttrs',attrValue,attr)
      }
    },
    computed:{
